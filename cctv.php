...
<body>
    ...
    <div class="main">
        <div class="main-color">
            <div class="main-text">
                <h1>CCTV</h1>
                <p> สามารถดูภาพจากกล้องวงจรปิด 2 กล้องในเวลาเดียวกัน ซึ่งสามารถเพิ่มหรือลบ IP เพื่อเปลี่ยนเเปลงกล้องที่ดูได้    <br><br><a href="register.php">Register</a>    เพื่อเป็นส่วนหนึ่งกับเรา</p>
