...
<body>
    ...
    <div class="main">
        <div class="main-color">
            <div class="main-text">
                <h1>Gallery</h1>
                <p> สามารถดูภาพเเละวีดีโอย้อนหลังที่ถูกบันทึกอยู่ในระบบ เป็นภาพเเละวีดีโอจากการตรวจจับได้  <br><br><a href="register.php">Register</a>    เพื่อเป็นส่วนหนึ่งกับเรา</p>
            </div>
        </div>
    </div>
