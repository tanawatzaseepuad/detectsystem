...
class videoStream1():
    def __init__(self, video_path='http://192.168.1.2:39190/videostream.cgi?user=admin&pwd=888888',folder_images = "C:/xampp/htdocs/image",folder_gifs = "C:/xampp/htdocs/uploads",target_fps = 3,camera_name = "Camera_2"):
